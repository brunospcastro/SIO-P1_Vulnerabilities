...
var sql = "INSERT INTO Users (username,pass,admin) values('admin','admin',true);";
    con.query(sql, function (err, result) {
      if (err) throw err;
      console.log("1 record inserted  with success in Users table.");
    });

var sql = "INSERT INTO Users (username,pass,admin) values('George','tsunami',false);";
    con.query(sql, function (err, result) {
      if (err) throw err;
      console.log("1 record inserted  with success in Users table.");
    });

var sql = "INSERT INTO Users (username,pass,admin) values('David','Golias',false);";
    con.query(sql, function (err, result) {
      if (err) throw err;
      console.log("1 record inserted  with success in Users table.");
    });
